  ...
  return (
    <ModalDesign>
      <ModalBox>
        ...
        <div> " 봄바람이 소곤소곤 전하는 벚꽃의 속삭임처럼, 우리의 모임도 그 시작을 알립니다. 이곳은 비트모빅 커뮤니티의 중심지, 관악산의 생기와 봄날의 따스함이 가득한 MOBICK STATION으로 여러분을 초대합니다."</div>
        <div> 오픈 전 단장 중이에요. :)</div>
        <div> 입점 신청을 위해 공개하였고, 홈페이지는 매주 업데이트합니다.</div>
        <div>
          MOBICK STATION은 비둘기호 선원들인 모비커의 활동과 함께 성장합니다.
          종이지갑 및 굿즈 등 입점 신청을 받습니다.
          입점수요 조사 및 피드백 조율 후 홈페이지를 매주 업데이트합니다.
          피드백 및 불편한 점 등 더 나은 서비스를 위한 의견을 자유롭게 공유해주세요.
        </div>
        <div>"함께하는 모든 순간이 축제처럼 기쁘고</div>
        <div>지나간 시간 속 추억처럼 아름다운 여운을 남길 수 있기를 바랍니다.</div>
