...
const RecommendFourthNavi = styled.div`
    ...
    & > div:nth-child(2) {
        ${({ activeTab }) => activeTab === '베스트셀러' && 'border-bottom: 1px solid lightgray;'}
    }
`;
                ...
                {activeTab === "베스트셀러"
                    ? <RecommendThirdListA>
                        ...
                        {[1, 2, 3, 4, 5, 6, 7].map((item, index) => {
                            return (
                                <StyledFourthRankItem key={index}>{item}. 베스트 셀러 종이지갑</StyledFourthRankItem>
                            )
                        })}
                    </RecommendThirdListA>
                    : <RecommendThirdListB>
                        ...
                        {[1, 2, 3, 4, 5, 6, 7].map((item, index) => {
                            return (
                                <StyledFourthRankItem key={index}>{item}. 인기 검색어 입니다</StyledFourthRankItem>
                            )
                        })}
                    </RecommendThirdListB>
                }
